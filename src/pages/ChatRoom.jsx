    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-teal-950 to-slate-900 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 relative z-10">
        <div className="bg-black/50 backdrop-blur-xl rounded-3xl border border-teal-500/30 shadow-2xl flex flex-col h-[85vh] overflow-hidden">
          ...
          {/* Messages */}
          <div className="flex-1 overflow-y-auto p-6 bg-gradient-to-b from-black/20 via-black/30 to-black/40 scrollbar-thin scrollbar-thumb-teal-500/30 scrollbar-track-transparent hover:scrollbar-thumb-teal-500/50">
            {messages.length === 0 ? (
            ...
            <form onSubmit={sendMessage} className="flex items-end gap-3">
              <div className="flex-1 relative">
                <input
                  ...
                  className="w-full px-5 py-3.5 pr-12 rounded-2xl bg-black/50 backdrop-blur-sm text-white placeholder-gray-500 border-2 border-teal-500/20 focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/30 transition-all shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
